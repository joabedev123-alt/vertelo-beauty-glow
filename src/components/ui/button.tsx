  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium font-body transition-all duration-300 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        hero: 
          "bg-primary text-primary-foreground shadow-elevated hover:shadow-glow hover:scale-[1.03] active:scale-[0.98] font-semibold tracking-wide",
        "hero-outline":
          "border-2 border-primary/30 bg-transparent text-foreground hover:border-primary hover:bg-primary/5 backdrop-blur-sm",
        glass:
          "bg-card/60 backdrop-blur-md border border-border/50 text-foreground shadow-soft hover:bg-card/80 hover:shadow-card",
        whatsapp:
          "bg-[hsl(145,63%,49%)] text-primary-foreground shadow-elevated hover:bg-[hsl(145,63%,42%)] hover:shadow-glow hover:scale-[1.03] active:scale-[0.98]",
      },
      size: {
